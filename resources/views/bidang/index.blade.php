                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-header border-bottom pb-0 mb-3">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">Data Bidang</h6>
                                <p class="text-sm">Informasi Bidang dalam organisasi</p>
                            </div>
                    ...
                    <div class="table-responsive p-0">
                        <table id="bootstrap-data-table" class="table align-items-center mb-0">
                            <thead class="bg-gray-100">
                                <tr>
                                    {{-- <th>No</th> --}}
                                    <th class="text-secondary text-xs font-weight-semibold opacity-7">Kode Bidang</th>
                                    <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Nama Bidang</th>
                                    {{-- <th class="text-secondary text-xs font-weight-semibold opacity-7">Tugas</th> --}}
